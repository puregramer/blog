...
{#if visible}
    <section transition:fade>
        {#await import('../components/Stars/Stars.svelte') then app}
            <svelte:component this={app.default} warp={warp} />
        {/await}
        <div id="main-container" class="relative px-6 lg:px-8">
                ...
                <div class="relative">
                    ...
                    <div class="absolute inset-x-4 inset-y-12">
                        ...
                        <div class="mt-8 flex gap-x-4 sm:justify-center">
                            <a href="/introduce/" on:click|preventDefault={enterHandler}
